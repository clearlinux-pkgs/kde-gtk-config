...
Source0  : https://download.kde.org/stable/plasma/5.14.2/kde-gtk-config-5.14.2.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.2/kde-gtk-config-5.14.2.tar.xz.sig
...
%prep
%setup -q -n kde-gtk-config-5.14.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1540468007
mkdir -p clr-build
pushd clr-build
%cmake ..
