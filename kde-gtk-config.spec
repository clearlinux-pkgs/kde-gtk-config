...
Source0  : https://download.kde.org/stable/plasma/5.24.4/kde-gtk-config-5.24.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.24.4/kde-gtk-config-5.24.4.tar.xz.sig
...
%prep
%setup -q -n kde-gtk-config-5.24.4
cd %{_builddir}/kde-gtk-config-5.24.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648657505
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kde-gtk-config-5.24.4/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/kde-gtk-config/680ed9349d3d12bd39ddd36e8c4bc6b1b0cb1c0e
cp %{_builddir}/kde-gtk-config-5.24.4/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kde-gtk-config/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kde-gtk-config-5.24.4/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kde-gtk-config/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/kde-gtk-config-5.24.4/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kde-gtk-config/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/kde-gtk-config-5.24.4/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kde-gtk-config/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/kde-gtk-config-5.24.4/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kde-gtk-config/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kde-gtk-config-5.24.4/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kde-gtk-config/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
