...
Version  : 6.1.2
Release  : 107
URL      : https://download.kde.org/stable/plasma/6.1.2/kde-gtk-config-6.1.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.2/kde-gtk-config-6.1.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.2/kde-gtk-config-6.1.2.tar.xz.sig
...
%setup -q -n kde-gtk-config-6.1.2
cd %{_builddir}/kde-gtk-config-6.1.2
pushd ..
cp -a kde-gtk-config-6.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720595470
mkdir -p clr-build
pushd clr-build
