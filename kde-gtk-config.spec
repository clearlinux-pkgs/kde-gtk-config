...
Source0  : https://download.kde.org/stable/plasma/5.14.1/kde-gtk-config-5.14.1.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.1/kde-gtk-config-5.14.1.tar.xz.sig
...
%prep
%setup -q -n kde-gtk-config-5.14.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1539701568
mkdir -p clr-build
pushd clr-build
%cmake ..
