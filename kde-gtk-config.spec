...
Version  : 6.1.0
Release  : 105
URL      : https://download.kde.org/stable/plasma/6.1.0/kde-gtk-config-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.0/kde-gtk-config-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.0/kde-gtk-config-6.1.0.tar.xz.sig
...
%setup -q -n kde-gtk-config-6.1.0
cd %{_builddir}/kde-gtk-config-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718823129
mkdir -p clr-build
pushd clr-build
