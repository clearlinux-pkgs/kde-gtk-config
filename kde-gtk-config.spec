...
Source0  : https://download.kde.org/stable/plasma/6.0.0/kde-gtk-config-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.0/kde-gtk-config-6.0.0.tar.xz.sig
...
%prep
%setup -q -n kde-gtk-config-6.0.0
cd %{_builddir}/kde-gtk-config-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709338758
mkdir -p clr-build
pushd clr-build
