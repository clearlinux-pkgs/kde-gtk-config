...
Source0  : https://download.kde.org/stable/plasma/6.1.5/kde-gtk-config-6.1.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.5/kde-gtk-config-6.1.5.tar.xz.sig
...
%setup -q -n kde-gtk-config-6.1.5
cd %{_builddir}/kde-gtk-config-6.1.5
pushd ..
cp -a kde-gtk-config-6.1.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725992647
mkdir -p clr-build
pushd clr-build
