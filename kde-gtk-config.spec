...
Version  : 5.26.3
Release  : 78
URL      : https://download.kde.org/stable/plasma/5.26.3/kde-gtk-config-5.26.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.3/kde-gtk-config-5.26.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.3/kde-gtk-config-5.26.3.tar.xz.sig
...
%prep
%setup -q -n kde-gtk-config-5.26.3
cd %{_builddir}/kde-gtk-config-5.26.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667923351
mkdir -p clr-build
pushd clr-build
