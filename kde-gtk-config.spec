...
Version  : 6.0.2
Release  : 96
URL      : https://download.kde.org/stable/plasma/6.0.2/kde-gtk-config-6.0.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.2/kde-gtk-config-6.0.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.2/kde-gtk-config-6.0.2.tar.xz.sig
...
%prep
%setup -q -n kde-gtk-config-6.0.2
cd %{_builddir}/kde-gtk-config-6.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710286723
mkdir -p clr-build
pushd clr-build
