...
Version  : 6.3.3
Release  : 122
URL      : https://download.kde.org/stable/plasma/6.3.3/kde-gtk-config-6.3.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.3/kde-gtk-config-6.3.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.3/kde-gtk-config-6.3.3.tar.xz.sig
...
%setup -q -n kde-gtk-config-6.3.3
cd %{_builddir}/kde-gtk-config-6.3.3
pushd ..
cp -a kde-gtk-config-6.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742491169
mkdir -p clr-build
pushd clr-build
