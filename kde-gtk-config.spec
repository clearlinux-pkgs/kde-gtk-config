...
Source0  : https://download.kde.org/stable/plasma/6.2.0/kde-gtk-config-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.0/kde-gtk-config-6.2.0.tar.xz.sig
...
%setup -q -n kde-gtk-config-6.2.0
cd %{_builddir}/kde-gtk-config-6.2.0
pushd ..
cp -a kde-gtk-config-6.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728618883
mkdir -p clr-build
pushd clr-build
