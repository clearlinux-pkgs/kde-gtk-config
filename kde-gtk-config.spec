...
Source0  : https://download.kde.org/stable/plasma/6.1.3/kde-gtk-config-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/kde-gtk-config-6.1.3.tar.xz.sig
...
%setup -q -n kde-gtk-config-6.1.3
cd %{_builddir}/kde-gtk-config-6.1.3
pushd ..
cp -a kde-gtk-config-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721150119
mkdir -p clr-build
pushd clr-build
