...
Source0  : https://download.kde.org/stable/plasma/5.26.1/kde-gtk-config-5.26.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.1/kde-gtk-config-5.26.1.tar.xz.sig
...
%prep
%setup -q -n kde-gtk-config-5.26.1
cd %{_builddir}/kde-gtk-config-5.26.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666281038
mkdir -p clr-build
pushd clr-build
