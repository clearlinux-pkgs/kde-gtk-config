...
Version  : 6.0.3
Release  : 100
URL      : https://download.kde.org/stable/plasma/6.0.3/kde-gtk-config-6.0.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.3/kde-gtk-config-6.0.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.3/kde-gtk-config-6.0.3.tar.xz.sig
...
%prep
%setup -q -n kde-gtk-config-6.0.3
cd %{_builddir}/kde-gtk-config-6.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711649215
mkdir -p clr-build
pushd clr-build
