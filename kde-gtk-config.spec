...
Version  : 6.2.4
Release  : 114
URL      : https://download.kde.org/stable/plasma/6.2.4/kde-gtk-config-6.2.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.4/kde-gtk-config-6.2.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.4/kde-gtk-config-6.2.4.tar.xz.sig
...
%setup -q -n kde-gtk-config-6.2.4
cd %{_builddir}/kde-gtk-config-6.2.4
pushd ..
cp -a kde-gtk-config-6.2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735241678
mkdir -p clr-build
pushd clr-build
